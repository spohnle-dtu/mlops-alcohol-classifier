...
def train(cfg: DictConfig):
    ...
    for epoch in range(1, cfg.model.epochs + 1):
        ...
        print(f"Epoch [{epoch}/{cfg.model.epochs}] - Train Acc: {epoch_train_acc:.3f} | Val Acc: {epoch_val_acc:.3f}")
        ...
        history.append({"epoch": epoch, "train_acc": epoch_train_acc, "val_acc": epoch_val_acc})
